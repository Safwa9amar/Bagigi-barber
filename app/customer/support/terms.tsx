...
export default function Terms() {
    ...
    const sections = t("support.terms.sections", { returnObjects: true }) as Array<{ title: string; content: string }>;
    ...
    return (
        <View style={styles.container} className="bg-background-light dark:bg-background-dark">
            <View style={styles.header} className="bg-white dark:bg-background-muted shadow-sm dark:shadow-none">
                ...
                <Text style={styles.headerTitle} className="text-typography-900 dark:text-typography-white">{t("support.terms.title")}</Text>
                <View style={{ width: 24 }} />
            </View>
