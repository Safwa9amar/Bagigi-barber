        ...
        <View className="flex-1 bg-gray-50 dark:bg-[#0F0F0F]">
            ...
            <View className="pt-14 px-5 pb-6 bg-white dark:bg-[#0F0F0F] flex-row items-center border-b border-gray-100 dark:border-gray-800">
                ...
                <View>
                    ...
                    <Text className="text-gray-400 font-bold text-[10px] uppercase tracking-widest">{t("support.developer.title")}</Text>
                </View>
            </View>
            ...
            <ScrollView className="flex-1 p-5" showsVerticalScrollIndicator={false}>
                <View className="items-center mb-8 mt-4">
                    ...
                    <Text className="text-[#C5A35D] font-black text-[10px] uppercase tracking-widest tracking-widest mt-1">
                        {t("support.developer.role")}
                    </Text>
                </View>

                <InfoItem
                    icon="person-outline"
                    label={t("support.developer.labels.name")}
                    value="Hassani Hamza"
                />

                <InfoItem
                    icon="call-outline"
                    label={t("support.developer.labels.phone")}
                ...
                <InfoItem
                    icon="mail-outline"
                    label={t("support.developer.labels.email")}
                ...
                <InfoItem
                    icon="globe-outline"
                    label={t("support.developer.labels.portfolio")}
                ...
                <View className="mt-8 p-6 rounded-[32px] bg-[#C5A35D] items-center shadow-lg shadow-[#C5A35D]/40">
                    <Text className="text-white font-black text-sm uppercase tracking-widest text-center">
                        {t("support.developer.quote")}
                    </Text>
                    <Text className="text-white/80 font-bold text-[10px] mt-2 text-center">
                        {t("support.developer.availability")}
                    </Text>
                </View>
