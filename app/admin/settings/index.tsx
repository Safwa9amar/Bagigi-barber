  ...
  return (
    <View className="flex-1 bg-gray-50 dark:bg-[#0F0F0F]">
      <View className="pt-14 px-5 pb-6 bg-white dark:bg-[#0F0F0F]">
        <Text className="text-2xl font-black text-[#1A1A1A] dark:text-white mb-2">
          {t("tabs.settings") || "Settings"}
        </Text>
        <Text className="text-gray-400 font-bold text-xs">
          {t("admin.settings.manageDesc") || "Manage your business and account"}
        </Text>
      </View>
      ...
      >
        <View className="mb-8">
          <Text className="text-gray-400 font-black text-[10px] uppercase tracking-widest ml-1 mb-3">
            {t("admin.settings.shopManagement")}
          </Text>
          <SettingItem
            icon="time-outline"
        ...
        <View className="mb-8">
          <Text className="text-gray-400 font-black text-[10px] uppercase tracking-widest ml-1 mb-3">
            {t("admin.settings.appPreferences")}
          </Text>
          <SettingItem
        ...
        >
          ...
          <Text className="flex-1 ml-4 text-sm font-black text-red-500">
